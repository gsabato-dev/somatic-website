          ...
          <div className="max-w-6xl mx-auto mb-12">
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="space-y-4 text-[#4A5568] leading-relaxed">
                <p>
                  I'm <strong>Gabriele</strong>, a Trained <a href="https://www.somaticainstitute.com/" target="_blank" rel="noopener noreferrer" className="text-[#C97857] hover:underline transition-colors">Somatica®</a> Coach helping women who want to reconnect to their bodies, desire, and pleasure.
                </p>
                <p>
